        ...
        <div id="line">
          ...
          <v-form v-model="valid">
            ...
            <transition-group name="form" tag="div">
              <div
                v-for="(motives, motive_index) in Motives"
                :key="motive_index"
              >
          ...
          <v-form v-model="valid">
            ...
            <transition-group name="form" tag="div">
              <div
                ...
                self_index) in SelfTranscendence"
                :key="self_index"
              >
                <!-- If it's two or more forms, show ✘, and label and hint is hide. -->
                  ...
                  <v-row>
                    <v-col cols="11" md="11">
                      <v-textarea
                        ...
                        auto-grow
                        v-model="
                          self_transcendence_goals.self_transcendence_goals
                        "
                      ></v-textarea>
                    </v-col>
                    <v-col cols="1">
          ...
          <v-form v-model="valid">
            ...
            <transition-group name="form" tag="div">
              <div
                v-for="(future_selves,
                future_selves_index) in FutureSelves"
                  ...
                  <v-row>
                    <v-col cols="11" md="11">
                      <v-textarea
                        rows="1"
                        auto-grow
                        v-model="future_selves.future_selfs"
                      ></v-textarea>
                    </v-col>
                    <v-col cols="1">
                      <!-- Form Delete Buttom -->
...
export default {
  ...
  data: function () {
    return {
      ...
      Motives: [{ motives: "" }],
      SelfTranscendence: [{ self_transcendence_goals: "" }],
      FutureSelves: [{ future_selfs: "" }]
    };
  },
  ...
  methods: {
    ...
    addMotiveForm: function () {
      const form = { motives: "" };
      this.Motives.push(form);
    },

    addSelfTranscendenceGoalForm: function () {
      const form = { self_transcendence_goals: "" };
      this.SelfTranscendence.push(form);
    },

    addFutureSelf: function () {
      const form = { future_selfs: "" };
      this.FutureSelves.push(form);
    },
    ...
    deleteSelfTranscendenceGoalForm(index) {
      this.SelfTranscendence.splice(index, 1);
    },

    deleteFutureSelfForm(index) {
      this.FutureSelves.splice(index, 1);
    },
    endEdit: function () {
      this.$emit("close");
    }
